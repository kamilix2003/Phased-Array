...
def main():
  ...
  ax.set_title("Phase Shifter S21 Magnitudes", fontsize=fs_title)
  ax.grid()
  # ax.set_yticks(np.arange(-4, 0, 0.1), minor=True)
  ax.set_yticks(np.arange(-4, 1, .5), minor=False)
  # ax.set_xticks(np.arange(2, 5, 0.1), minor=True)
  ax.set_xticks(np.arange(2, 5, 0.25), minor=False)
  ax.legend()
  ax.set_xlim(2, 4)
  ax.set_ylim(-4, -2)
  ...
  ax.set_xlabel("Frequency (GHz)", fontsize=fs_label)
  ax.set_ylabel("Magnitude (dB)", fontsize=fs_label)
  ax.set_title("Phase Shifter S11 Magnitudes", fontsize=fs_title)
  ax.grid()
  ...
  ax.set_xlabel("Frequency (GHz)", fontsize=fs_label)
  ax.set_ylabel("Magnitude (dB)", fontsize=fs_label)
  ax.set_title("Phase Shifter S22 Magnitudes", fontsize=fs_title)
  ax.grid()
  # ax.set_yticks(np.arange(-40, 0, 1), minor=True)
  ax.set_yticks(np.arange(-40, 1, 5), minor=False)
  # ax.set_xticks(np.arange(2, 5, 0.1), minor=True)
  ...
  ax.grid()
  ax.set_xlabel("Frequency (GHz)", fontsize=fs_label)
  ax.set_ylabel("Phase Shift Error (Degrees)", fontsize=fs_label)
  ax.legend()
  ax.set_title("Absolute RMS Phase Shift Error", fontsize=fs_title)
  ...
  ax.grid()
  ax.set_xlabel("Frequency (GHz)", fontsize=fs_label)
  ax.set_ylabel("Relative Phase Shift Error (%)", fontsize=fs_label)
  ax.legend()
  ax.set_title("Relative RMS Phase Shift Error", fontsize=fs_title)
