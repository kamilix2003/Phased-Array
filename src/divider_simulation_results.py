...
def main():
  ...
  ax.set_title("2-way Divider Simulation Results Comparison")
  ...
  ax.set_xlabel("Frequency (GHz)")
  ax.set_ylabel("Magnitude (dB)")
  ax.set_title("2-way Divider Symbolic Simulation Results")
  ...
  ax.set_xlabel("Frequency (GHz)")
  ax.set_ylabel("Magnitude (dB)")
  ax.set_title("2-way Divider S11")
  ...
  ax.set_xlabel("Frequency (GHz)")
  ax.set_ylabel("Magnitude (dB)")
  ax.set_title("2-way Divider S21")
  ...
  ax.set_xlabel("Frequency (GHz)")
  ax.set_ylabel("Magnitude (dB)")
  ax.set_title("2-way Divider S32")
